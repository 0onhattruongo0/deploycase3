                        ...
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            ...
                            @if(\Illuminate\Support\Facades\Session::has('register-success'))
                                <div class="alert alert-success">
                                    {{ \Illuminate\Support\Facades\Session::get('register-success') }}.
                                    <a href="{{route('userlogin')}}">Đăng nhập</a>. Quay lại <a href="/">Trang chủ</a>
                            ...
                            <div class="card-body">
                                <form action="{{route('register')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4" id="inputEmail" name="email" type="email" placeholder="Enter Email" />
                                    </div>
                                    <div class="form-group">
